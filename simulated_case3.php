...
// **lock row first to force contention**
$mysqli->query("SELECT * FROM Users WHERE id = $targetId FOR UPDATE");

$ts = microtime(true);
$version = (int) round($ts * 1000000);
...
// longer sleep to guarantee overlap
usleep(700000); // 0.7s
